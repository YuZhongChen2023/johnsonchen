...
@app.route("/")
def index():
    homepage = "<h1>陳昱中Python網頁12/07</h1>"
    ...
    homepage += "<br><a href=/searchmovie>查詢開眼電影即將上映影片</a><br>"
    ...
    if request.method == "POST":
        ...
        for doc in docs:
            if MovieTitle in doc.to_dict()["title"]: 
                ...
                info += "影片介紹：<a href=" + doc.to_dict()["hyperlink"] + "<br>"
...
def webhook3():
    ...
    if (action == "rateChoice"):
        rate =  req.get("queryResult").get("parameters").get("rate")
        info = "我是陳昱中開發的電影聊天機器人,您選擇的電影分級是：" + rate + "，相關電影：\n"
        db = firestore.client()
